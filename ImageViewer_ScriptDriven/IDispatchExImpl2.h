...
#ifndef __IDispatchExImpl2_H__
#define __IDispatchExImpl2_H__
...
class __declspec(novtable) IDispatchExImpl2 : public IDispatchBaseImpl<DERIVED_CLASS, BASE_ITF, BASE_IID>
{
protected:
...
//	ThreadSafeRefCount	m_csAccessSync;
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetEntryByName()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::CreateNewEntry()
	* Args:		<BSTR> bstrName - the name of the entry to find
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetStartDispID()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetNextDispID()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetVariantByDispID()
	...
	***************************************************************************/
		...
		if (SUCCEEDED(hr))
		{
			...
			if (it != m_mapDispidToEntry.end()) 
			{
				...
				if (pEntry->UseTypeInfo() == false)
				{
					...
					////////////////////////////////////////////////////////////
					// Give the Appliation a chance to provide key-value pair.
					if (pvtResult->vt == VT_EMPTY)
					{
						hr = GetValueOfKey(pEntry->GetName(), pvtResult);
					}
					////////////////////////////////////////////////////////////
				}
				else
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::SetVariantByDispID()
	* Args:		<DISPID> dispid - the current dispid to search for
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::AddTypeInfoDispIDs()
	* Args:		None
	* Returns:	<HRESULT> Standard COM codes
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::InvokeByDispID()
...
protected:
	////////////////////////////////////////////////////////////
	// Give the Appliation a chance to provide key-value pair.
	// Normally subclasses should override these two methods.
...
public:
	IDispatchExImpl2() : m_dispidNext(DISPID_START)
	{
	}

	virtual ~IDispatchExImpl2()
	{
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetTypeInfoCount()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetTypeInfo()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetIDsOfNames()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::Invoke()
	* Args:		<DISPID> dispid - the dispid of the entry to invoke
	*			<REFIID> ignored
	*			<LCID> lcid - the locale id
	*			<WORD> wFlags - calling flags
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::DeleteMemberByDispID()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::DeleteMemberByName()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetDispID()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetMemberName()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetMemberProperties()
	* Args:		<DISPID> dispid - the dispid to get the name of
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::GetNameSpaceParent()
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Function:	IDispatchExImpl2::InvokeEx()
	* Args:		<DISPID> dispid - the dispid of the entry to invoke
	*			<LCID> lcid - the locale id
	*			<WORD> wFlags - calling flags
	*			<DISPPARAMS*> pDispParams - the dispparams of the method
